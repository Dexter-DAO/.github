...
- :green_circle:  **[mpp-specs](https://github.com/Dexter-DAO/mpp-specs)** — Canonical specification for the Machine Payments Protocol. The "Payment" HTTP authentication scheme defined.
